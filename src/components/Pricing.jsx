    ...
    return (
        <section style={{ padding: '6rem 2rem', display: 'flex', justifyContent: 'center' }}>
            <div className="glass-panel" style={{
                ...
                <h2 className="section-title text-yellow" style={{ margin: 0 }}>Secure Your Spot</h2>
                ...
                <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: '2rem', width: '100%' }}>
                    ...
                    >
                        <h4 style={{ color: 'var(--glow-cyan)', marginBottom: '1rem', letterSpacing: '2px' }}>EARLY BIRD</h4>
                        <strong style={{ fontSize: '3.5rem', display: 'block' }}>₹250</strong>
                    ...
                    <div style={{
                        ...
                        transition: 'transform 0.3s',
                        cursor: 'default'
                    }} onMouseEnter={(e) => e.currentTarget.style.transform = 'scale(1.15) translateY(-10px)'}
                        onMouseLeave={(e) => e.currentTarget.style.transform = 'scale(1.1) translateY(0)'}
                    >
                        <div style={{
                            position: 'absolute',
                            top: '-15px',
                        ...
                        <h4 style={{ color: 'var(--heading-yellow)', marginBottom: '1rem', letterSpacing: '2px' }}>SPOT REGISTRATION</h4>
                        <strong style={{ fontSize: '4rem', display: 'block', color: 'var(--heading-yellow)' }}>₹300</strong>
                ...
                <a href="https://forms.gle/Fj3hHDK1RuGb7RW77" target="_blank" rel="noreferrer" className="btn-primary" style={{ marginTop: '2rem', fontSize: '1.2rem', padding: '1rem 3rem' }}>
                    REGISTER NOW FAST
                </a>
            </div>
        </section>
